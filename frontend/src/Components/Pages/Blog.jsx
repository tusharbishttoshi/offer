...
function Blog() {
  ...
  // Assuming zodiac is passed through state object
  const zodiacValue = location.state;
  ...
  useEffect(() => {
    zodiac && dispatch(myHoroscopy({ sign: zodiac||"Scorpio" })).then((e) => setHoroscope(e.payload.data.prediction))
  }, [zodiac])
  useEffect(()=>{
