...
export default function InvoiceAstroManagement({astro}) {
                ...
                <tbody style={{ overflow: "scroll" }}>
                  {Transaction?.map((user, index) => (
                    <tr key={user?._id}>
                      ...
                      <td className="fs-7"> {user?.transactionID || "N/A"} </td>
                      <td className="fs-7"> {user?.name || "N/A"} </td>

                      <td
                        className="fs-7"
                        style={{
                          color: user?.amount <= 0 ? "#5CFF5C" : "#f06445",
                        }}
                      >
                        $-{user?.amount?.toFixed(2) || user?.amount}
                      </td>

                      <td
                        className="fs-7"
                        style={{
                          color: user?.balance >= 0 ? "#5CFF5C" : "#f06445",
                        }}
                      >
